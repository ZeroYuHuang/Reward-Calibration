...
if __name__ == "__main__":
    ...
    model_outputs_name = "model_outputs_BTRM_Qwen2_7b_0613.json"
    ...
    for i, m in tqdm(enumerate(models)):
        ...
        for batch_data in tqdm(dataset):
            template_message = tokenizer.apply_chat_template(batch_data["messages"], tokenize=False, add_generation_prompt=False)
